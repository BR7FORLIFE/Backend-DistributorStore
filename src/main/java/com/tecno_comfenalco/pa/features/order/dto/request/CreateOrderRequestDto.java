...
public record CreateOrderRequestDto(
        @NotNull(message = "La id de la tienda no debe ser nulo!") @Positive(message = "La id de la tienda debe ser un numero positivo!") String store_id,
        @NotNull(message = "La id de la distribuidora no debe ser nulo!") @Positive(message = "La id de la distribuidora debe ser positivo!") String distributor_id,
